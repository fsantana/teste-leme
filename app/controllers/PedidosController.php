...
use app\models\ImagemUploadForm;
...
class PedidosController extends Controller
{
    ...
    public function actionNovaimagem($id)
    {
        $pedido = $this->findModel($id);
        $imageUpload = new ImagemUploadForm();

        if (Yii::$app->request->isPost) {
            $imageUpload->imageFiles = UploadedFile::getInstances($imageUpload, 'imageFiles');
            if ($imageUpload->upload($pedido)) { 
                return $this->redirect(['view', 'id' => $id]);
            }
            
        }

        return $this->render('image_upload', ['model' => $imageUpload]);
    }
